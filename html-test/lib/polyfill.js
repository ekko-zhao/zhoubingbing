...
(function (global) {
    ...
    [
        ...
        if (!(p[0] in global.XMLHttpRequest)) global.XMLHttpRequest[p[0]] = p[1];
    });
...
(function (global) {
    ...
    function isSimpleHeader(name, value) {
        ...
        return name === 'accept' || name === 'accept-language' || name === 'content-language' ||
            (name === 'content-type' && ['application/x-www-form-encoded', 'multipart/form-data', 'text/plain'].indexOf(value) !== -1);
    }
    ...
    function fetch(input, init) {
        return new Promise(function (resolve, reject) {
            ...
            for (var iter = r.headers[Symbol.iterator](), step = iter.next(); !step.done; step = iter.next())
