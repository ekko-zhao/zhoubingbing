...
export class DetailModalComponent {
    ...
    public modalInit(transmit) {
        ...
        this.postForm['terminalNoOld'] = transmit['terminalNoOld'];
    ...
    // 设置 存储缓存的键
    public formStorageKey: string = 'countSpecialModalCountForm';
    public tableLocalKey: string = 'countSpecialModalTable';
