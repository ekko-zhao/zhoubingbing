...
@Component({
    selector: 'change-cellphone-modal',
    templateUrl: 'change-cellphone-modal.html',
    providers: [
        HttpService
    ]
})
export class ChangeCellphoneModalComponent {
    @Input() appModal;
    public transmit = {};
    ...
    public submit() {
        ...
        this.http.post('api/v1/user/admin/updateCellPhone', this.form).subscribe(
            response => {
