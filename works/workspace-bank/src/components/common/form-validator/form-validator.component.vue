...
/*
    ...
    .input状态 ：
        pristine dirty valid invalid && minlength maxlength mincharlength maxcharlength pattern required
    ...
    .如果有 v-model 指令,需要设置 data-model 和 那么属性， v-model 和 data-model 值保持一直
    ...
    1.  import FormValidatorComponent from 'components/common/form-validator/form-validator.component.vue';
