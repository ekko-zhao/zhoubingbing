...
@Component({
    templateUrl: './detail-direct.html',
    providers: [
        HttpService,
        DatePipe
    ]
})
export class DetailDirectComponent implements OnInit {
    // 表单
    public form = {};
    public postForm = {};
    public regex = regex;
    ...
    // 设置 存储缓存的键
    public formStorageKey: string = 'tradeDetailDirectForm';
    public tableLocalKey: string = 'tradeDetailDirectTable';
