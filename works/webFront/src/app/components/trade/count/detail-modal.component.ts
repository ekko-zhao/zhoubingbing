...
export class DetailModalComponent {
    ...
    // 设置 存储缓存的键
    public formStorageKey: string = 'countDetailModalCountForm';
    public tableLocalKey: string = 'countDetailModalTable';
    ...
    public table = {
        th: [
            ...
            { key: 'debitInfoName', text: '支付渠道', require: false },
            ...
            { key: 'feeRate', text: '费率', require: false },
            { key: 'rateLimit', text: '手续费上限', require: false },
            { key: 'settleState', text: '结算状态', require: false },
    ...
    public search(e?, page?: number, size: number = env['itemsPerPage']) {
        ...
        this.http.post('api/v1/transaction/queryTransactionDetail', this.postForm).subscribe(
            response => {
